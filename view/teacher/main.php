  ...
  <div class="grid grid-cols-2 gap-x-10 w-full">
    ...
    <div class="grid grid-cols-3 w-full h-full p-6 border rounded-lg shadow bg-gray-800 border-gray-700 hover:bg-gray-700">
      ...
      <a href="#2">
        ...
        <p class="font-normal text-gray-400">2 profesores</p>
      </a>
      <a href="#3">
...
<div class="flex justify-between items-center pb-4 pt-8">
  ...
  <button type="button" data-modal-toggle="newUser" class="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-1.5 bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-green-800">Nuevo profesor</button>
